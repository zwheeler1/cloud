...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <h2 style="color:#66ccff">
    ...
    <h4  style="color:#66ccff"><b>Begin Information Search</b></h4>

       <p>
        <b>View List of Tables</b></p>
    <p>
        <b>&nbsp;</b><asp:Button ID="btnViewTables" runat="server" Text="View Tables" 
               onclick="btnViewTables_Click" 
               PostBackUrl="~/wfrmEDED/wfrmTable.aspx" />
    </p>
    
    <p>
        <b>Search for Specific Data </b>
    </p>
    <p>
        &nbsp;<asp:Button ID="btnSearchByName" runat="server" Text="Search By Name" 
            onclick="btnSearchByName_Click" 
            PostBackUrl="~/wfrmEDED/wfrmSearchByBName.aspx" />
    </p>

     <p>
        <b>Table Refresh Frequency </b>
    </p>
    <p>
        &nbsp;<asp:Button ID="btnTableRefresh" runat="server" Text="Refresh Frequency" 
            onclick="btnTableRefres_Click" 
            PostBackUrl="~/wfrmEDED/wfrmTableUpdateFrequencies.aspx" />
    </p>

     <p>
        <b>Download Searchable PDF Version - DED </b>
    </p>
    <p>
        &nbsp;<asp:Button ID="btnOpenPDF" runat="server" Text="Download DED - PDF Version" 
            onclick="btnOpenPDF_Click" />
...
<br/>In most cases, the data types are documented exactly as they are stored in the data mart. However, for numeric and decimal data types, which are essentially identical, the documentation refers to a data type of decimal for both.
  ...
  <br />
          ...
          <p>
        View List of Tables  <asp:HyperLink  ID="HyperLink1"  runat="server"  Text="View List of Tables"   NavigateUrl="~/wfrmEDED/wfrmTableUpdateFrequencies.aspx"> View List of Tables</asp:HyperLink>.
    </p>
   
    <p>
        Search for Specific Data  <asp:HyperLink  ID="HyperLink2"  runat="server"  Text="View List of Tables"   NavigateUrl="~/wfrmEDED/wfrmSearchByBName.aspx"> Search for Data</asp:HyperLink>.
    </p>
    <p>
        You can also find information on the Office of Housings <a href="http://go.microsoft.com/fwlink/?LinkID=152368&amp;clcid=0x409"
